...
date: 2026-03-20 4:30:00
description: Some photos from symposium, and a quick reflection
tags:
categories: 
featured: false
---
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/symposium1" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Our symposium setup.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/symposium2" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Robot in action.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/symposium3" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    roamr team.
